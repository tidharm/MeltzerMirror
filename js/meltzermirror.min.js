...
if (!ipinfoAccessToken) {
	alert("IPInfo Token not specified.\nGo to  https://ipinfo.io/account, obtain your token and populate the variable 'ipinfoAccessToken' in meltzermirror.min.js.");
	throw new Error();
}
if (!owmAppId) {
	alert("Open Weather Map App ID not specified.\nGo to  https://home.openweathermap.org/api_keys, obtain your App ID and populate the variable owmAppId in meltzermirror.min.js.");
	throw new Error();
}
